...
# Canonical SOST address format: "sost1" + 40 lowercase hex chars
# (the hex-encoded PubKeyHash). Total length 45. Defined in
# include/sost/address.h: address_encode() / address_valid().
# Earlier Trinity sprints used a bech32-shaped regex which rejected
# legitimate addresses generated by `sost-cli newwallet`; this
# hotfix aligns the validator with the on-chain encoding.
SOST_ADDRESS_PATTERN = r"^sost1[0-9a-f]{40}$"
_ADDRESS_RE = re.compile(SOST_ADDRESS_PATTERN)
