...
**Current state (Phase 24 — first real GEE validation, spatial alignment blocker):**
...
- Phase 24: First real GEE validation on exported rasters (no simulation). 4 zones exported: Chuquicamata (267 S2), Zambia (528), Kalgoorlie (180), Peru (55). Spectral unmixing real features computed on 500 real pixels/zone. NDVI trend: 12 years real Landsat data/zone. Zambia NDVI promising (mean 0.310, slope +0.0032/yr), Chuquicamata not applicable (mean 0.042, hyperarid). Validation blocked by spatial alignment between GEE pixels and labels. Gating v10. Registry v20.
- Phase 23: GEE pipelines built for raw S2 reflectance (4 zones, 10 bands) and multi-year NDVI (12 years, 4 zones). Sample-tested with real data. Full export pending. Frontier validation PIPELINE_READY. Gating v9. Registry v19.
...
**Phase 24 result:** First real frontier validation on exported GEE rasters (no simulation). 4 zones exported: Chuquicamata (267 S2 images), Zambia (528), Kalgoorlie (180), Peru (55). Spectral unmixing: real features computed on 500 real pixels per zone. NDVI trend: 12 years real Landsat data per zone. Zambia NDVI promising (mean 0.310, slope +0.0032/yr). Chuquicamata NDVI not applicable (mean 0.042, hyperarid). Validation blocked: spatial alignment between GEE pixels and labels needed before AUC can be measured. Canonical unchanged 22.8/40 (57%) — real features exist but AUC not measurable yet. Next: spatial alignment layer (Phase 25).
