...
// Matches Python: MAGIC = b"CXPOW3" + NETWORK_ID
...
inline constexpr int64_t R0_STOCKSHIS       = 785100863;  // 7.85100863 SOST
inline constexpr int64_t SUPPLY_MAX_STOCKSHIS = 466920160910299LL;
inline constexpr int64_t EMISSION_Q_NUM     = 7788007830714049LL;
inline constexpr int64_t EMISSION_Q_DEN     = 10000000000000000LL;
inline constexpr int64_t STOCKSHIS_PER_SOST = 100000000;
// Q16.16
...
inline constexpr int32_t CASERT_NORMAL_TH      = 50;
inline constexpr int32_t CASERT_DEGRADED_TH    = 200;
// CX mainnet
...
inline constexpr int32_t CX_STB_SCALE  = 3;
...
inline constexpr int32_t CX_C_NUM = 7; inline constexpr int32_t CX_C_DEN = 10;
inline constexpr int32_t CX_M_NUM = 1; inline constexpr int32_t CX_M_DEN = 1;
// CX dev
