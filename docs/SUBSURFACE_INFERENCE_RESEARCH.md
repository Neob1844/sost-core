...
**Status:** Strategic research document for GeoForge platform
...
Web interface: user selects area → system runs DEEPCORE → returns probability map + ranked targets. First sellable product: "AI-powered mineral exploration screening reports."
