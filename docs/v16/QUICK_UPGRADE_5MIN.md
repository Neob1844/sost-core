...
**Which release:** install **v16.2.1** — the current one, on your node **and**
...
**Official binaries:** https://github.com/Neob1844/sost-core/releases/tag/v16.2.1
...
git worktree add /opt/sost-v16 v16.2.1
cd /opt/sost-v16
...
git status --short
git fetch --all --tags --prune
git worktree add /home/sost/sost-v162 v16.2.1
