...
- **OTC-3b — EVM leg** — deploy + external-audit the EVM `AtomicSwapHTLC.sol`; issuer-freeze warnings in wallet/UI; end-to-end SOST↔EVM testnet swaps. (BTC regtest leg landed in OTC-3a.)
