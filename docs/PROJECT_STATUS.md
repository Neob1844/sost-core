...
- **Next action:** owner authorization to publish `sost-node-sec2` on the v16.3.0 page (no tag move, no overwrite of originals) then VPS swap. Do NOT mix with the P2P branch. Priority before block 29,900.
