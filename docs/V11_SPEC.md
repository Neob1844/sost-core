...
Pre-`V11_PHASE2_HEIGHT` blocks fall through to the legacy CB1-CB10 path with no behaviour change. While `V11_PHASE2_HEIGHT == INT64_MAX` (params.h), the Phase 2 path is unreachable from any real chain height.
