...
(function () {
  ...
  var DEV_NOTE_HTML = [
    ...
    '    <span class="sost-devnote-summary"><span style="color:#fb010d">SOST</span> is an experimental native Proof-of-Work project in pre-market testing &mdash; success, value, listings and adoption are not guaranteed.</span>',
    ...
    '    <p><span style="color:#fb010d">SOST</span> is being developed with engineering rigor, but that does not guarantee success, future value, liquidity, exchange listings, or community adoption.</p>',
    '    <p>Right now, <span style="color:#fb010d">SOST</span> is still an experimental native Proof-of-Work network in pre-market testing. Miners can participate with the current reference miner using CPU-oriented mining and approximately 8&nbsp;GB of RAM, but this does not mean that <span style="color:#fb010d">SOST</span> will necessarily become valuable.</p>',
    ...
    '      <li>That one or more exchanges may decide, at their own discretion, to list <span style="color:#fb010d">SOST</span> in the future.</li>',
    '    </ol>',
